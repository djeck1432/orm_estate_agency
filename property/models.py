...
class Complain(models.Model):
    ...
    complain_flat = models.ForeignKey(Flat, verbose_name="Квартира, на которую пожаловались:", on_delete=models.CASCADE)
    complain_text = models.TextField("Текст жалобы", null=True)
